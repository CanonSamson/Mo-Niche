    ...
    <div>
      ...
      <div className=" px-4 grid gap-2  bg-lime-100 pb-5 mb-[50px]">
        ...
        <p>
          ...
          wears TUBO feels and looks their best in our signature silhouette.{" "}
        </p>
        <p>
          Our mission is to empower women through clothes by preserving heritage
          and supporting the local community.
        </p>
        <p>Thank you for your interest in becoming a TUBOWOMAN!</p>
      </div>

      <div className=" mt-8 px-4 grid gap-2">
        <h3 className=" text-2xl font-medium">PRE-CONSULTATION</h3>
        <p>{`You’ve`} made the decision to become a TUBOWOMAN!</p>
        <p>
          Bespoke pieces are central to the TUBO brand; we undertake special
      ...
      <div className=" mt-10">
        ...
        <div className=" px-4 mt-5">
          ...
          <p>
            ...
            clients through every moment of their life, creating a TUBO fit just
            for you.
          </p>
          <p className=" mt-5">
